...
public final class Logger {
  ...
  public void readSpell(Character character, Spell spell) {
    String message =
        format(
            ...
            character.getType(), character.getName(), spell.getName());
  ...
  public void takeDamageTo(Character character, Spell spell, Character opponent, int damage) {
    String message =
        format(
            ...
            character.getType(), character.getName(), opponent.getName(), damage, spell.getName());
  ...
  public void characterAttack(Character aggressor, Character target) {
    String message =
        format(
            "%s \"%s\" атакует \"%s\"", aggressor.getType(), aggressor.getName(), target.getName());
  ...
  public void healing(Character character, int healingStrength, int newHealth) {
    String message =
        format(
            ...
            character.getType(), character.getName(), healingStrength, newHealth);
